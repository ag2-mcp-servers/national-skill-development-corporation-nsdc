...
class CertificateParameters(BaseModel):
    ...
    DOCID: str = Field(..., description='DOCID', examples=['14tsi98v6oz0shve'])
...
class EscerCertificatePostRequest(BaseModel):
...
class EscerCertificatePostResponse(BaseModel):
...
class EscerCertificatePostResponse1(BaseModel):
...
class EscerCertificatePostResponse2(BaseModel):
...
class EscerCertificatePostResponse3(BaseModel):
...
class EscerCertificatePostResponse4(BaseModel):
...
class EscerCertificatePostResponse5(BaseModel):
...
class EscerCertificatePostResponse6(BaseModel):
...
class CertificateParameters1(BaseModel):
    CentCID: str = Field(
        ..., description='Centre Candidate ID', examples=['DL0002A6-B000016C Or NA']
    )
    CertID: str = Field(
        ...,
        description='Unique Certificate Number',
        examples=['21F59B08F3244B03A80A4421E36749B3 Or NA'],
    )
    DOB: str = Field(
        ..., description='Date of birth in DD-MM-YYYY format', examples=['31-12-1980']
    )
...
class SkcerCertificatePostRequest(BaseModel):
...
class SkcerCertificatePostResponse(BaseModel):
...
class SkcerCertificatePostResponse1(BaseModel):
...
class SkcerCertificatePostResponse2(BaseModel):
...
class SkcerCertificatePostResponse3(BaseModel):
...
class SkcerCertificatePostResponse4(BaseModel):
...
class SkcerCertificatePostResponse5(BaseModel):
...
class SkcerCertificatePostResponse6(BaseModel):
